...
function ENT:OnTakeDamage( damageinfo )
	...
	if damager:Team() != self.TTG_Team and damageinfo:GetDamage() > 0 and inflictor:GetClass() == "default_melee" then

		--return damage if its the melee attack
